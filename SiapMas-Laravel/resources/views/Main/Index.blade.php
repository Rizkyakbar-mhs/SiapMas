          ...
          <div class="card card-login">
            <form class="form" method="" action="">
              ...
              <div class="footer text-center" style="margin-bottom: 10px">
                <a href="#pablo" class="btn btn-primary btn-round"><i class="material-icons">done</i> Login</a>
                <a href="#pablo" class="btn btn-primary btn-round"><i class="material-icons">help</i> Lupa Password</a>
              </div>
            </form>
          </div>
        </div>
