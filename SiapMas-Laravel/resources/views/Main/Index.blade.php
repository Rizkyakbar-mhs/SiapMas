          ...
          <div class="card card-login">   
            <form class="form" method="post" action="/login">
              ...
              <div class="footer text-center" style="margin-bottom: 10px">
                <button type="submit" class="btn btn-primary btn-round"><i class="material-icons"></i> Login</button>
                <a href="{{ url('/lupaPass') }}" class="btn btn-primary btn-round"><i class="material-icons"></i> Lupa Password</a>
              </div>
            </form>
          </div>
        </div>
